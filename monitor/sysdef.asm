...
VGA$SPRITE_BITMAP_PTR   .EQU    0x0002                  ; Value must be multiple of 0x0010
VGA$SPRITE_CSR          .EQU    0x0003

VGA$SPRITE_CSR_HICOLOR  .EQU    0x0001
VGA$SPRITE_CSR_BEHIND   .EQU    0x0002
VGA$SPRITE_CSR_MIRROR_X .EQU    0x0004
VGA$SPRITE_CSR_MIRROR_Y .EQU    0x0008
VGA$SPRITE_CSR_VISIBLE  .EQU    0x0010
...
SYSINFO$HW_NEXYS_4DDR   .EQU    0x0011                  ; - Nexys 4 DDR
SYSINFO$HW_NEXYS_A7100T .EQU    0x0012                  ; - Nexys A7-100T
SYSINFO$HW_MEGA65       .EQU    0x0020                  ; MEGA65 board
SYSINFO$HW_MEGA65_R2    .EQU    0x0021                  ; - Revision 2
SYSINFO$HW_MEGA65_R3    .EQU    0x0022                  ; - Revision 3
...
SCAN$F11                .EQU    0x0078
SCAN$F12                .EQU    0x0007
SCAN$PRT_SCR            .EQU    0x0E12
SCAN$SCROLL_LOCK        .EQU    0x007E
SCAN$TILDE              .EQU    0x000E
SCAN$KEY1               .EQU    0x0016
SCAN$KEY2               .EQU    0x001E
SCAN$KEY3               .EQU    0x0026
SCAN$KEY4               .EQU    0x0025
SCAN$KEY5               .EQU    0x002E
SCAN$KEY6               .EQU    0x0036
SCAN$KEY7               .EQU    0x003D
SCAN$KEY8               .EQU    0x003E
SCAN$KEY9               .EQU    0x0046
SCAN$KEY0               .EQU    0x0045
SCAN$MINUS              .EQU    0x004E
SCAN$EQUAL              .EQU    0x0055
SCAN$BACKSPACE          .EQU    0x0066
SCAN$TAB                .EQU    0x000D
SCAN$Q                  .EQU    0x0015
SCAN$W                  .EQU    0x001D
SCAN$E                  .EQU    0x0024
...
SCAN$O                  .EQU    0x0044
SCAN$P                  .EQU    0x004D
SCAN$LEFT_SQ_BRACKET    .EQU    0x0054
SCAN$RIGHT_SQ_BRACKET   .EQU    0x005B
SCAN$BACKSLASH          .EQU    0x005D
SCAN$CAPS_LOCK          .EQU    0x0058
SCAN$A                  .EQU    0x001C
SCAN$S                  .EQU    0x001B
SCAN$D                  .EQU    0x0023
SCAN$F                  .EQU    0x002B
...
SCAN$K                  .EQU    0x0042
SCAN$L                  .EQU    0x004B
SCAN$SEMICOLON          .EQU    0x004C
SCAN$APOSTROPHE         .EQU    0x0052
SCAN$ENTER              .EQU    0x005A
SCAN$LEFT_SHIFT         .EQU    0x0012
SCAN$Z                  .EQU    0x001A
SCAN$X                  .EQU    0x0022
SCAN$C                  .EQU    0x0021
SCAN$V                  .EQU    0x002A
...
SCAN$N                  .EQU    0x0031
SCAN$M                  .EQU    0x003A
SCAN$COMMA              .EQU    0x0041
SCAN$PERIOD             .EQU    0x0049
SCAN$SLASH              .EQU    0x004A
SCAN$SHIFT_RIGHT        .EQU    0x0059
SCAN$CTRL_LEFT          .EQU    0x0014
SCAN$WINDOWS_LEFT       .EQU    0x0E1F
SCAN$ALT_LEFT           .EQU    0x0011
SCAN$SPACE              .EQU    0x0029
SCAN$ALT_RIGHT          .EQU    0x0E11
SCAN$WINDOWS_RIGHT      .EQU    0x0E27
SCAN$MENUS              .EQU    0x0E2F
SCAN$CTRL_RIGHT         .EQU    0x0E14
SCAN$INSERT             .EQU    0x0E70
SCAN$HOME               .EQU    0x0E6C
SCAN$PAGE_UP            .EQU    0x0E7D
SCAN$DELETE             .EQU    0x0E71
SCAN$END                .EQU    0x0E69
SCAN$PAGE_DOWN          .EQU    0x0E7A
SCAN$UP_ARROW           .EQU    0x0E75
SCAN$LEFT_ARROW         .EQU    0x0E6B
SCAN$DOWN_ARROW         .EQU    0x0E72
SCAN$RIGHT_ARROW        .EQU    0x0E74
SCAN$NUMLOCK            .EQU    0x0077
SCAN$NUM_DIVIDE         .EQU    0x0E4A
SCAN$NUM_MULTIPLY       .EQU    0x007C
SCAN$NUM_MINUS          .EQU    0x007B
SCAN$NUM_7              .EQU    0x006C
SCAN$NUM_8              .EQU    0x0075
SCAN$NUM_9              .EQU    0x007D
SCAN$NUM_PLUS           .EQU    0x0079
SCAN$NUM_4              .EQU    0x006B
SCAN$NUM_5              .EQU    0x0073
SCAN$NUM_6              .EQU    0x0074
SCAN$NUM_1              .EQU    0x0069
SCAN$NUM_2              .EQU    0x0072
SCAN$NUM_3              .EQU    0x007A
SCAN$NUM_0              .EQU    0x0070
SCAN$NUM_PERIOD         .EQU    0x0071
SCAN$NUM_ENTER          .EQU    0x0E5A
