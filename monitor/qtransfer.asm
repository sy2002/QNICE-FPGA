...
;
;***************************************************************************************
;* QTRANSFER client receives data from the host.
;*
;* The contents of R8 to R12 are preserved during this function
;***************************************************************************************
;
QTRANSFER       MOVE    STR_TITLE, R8
                SYSCALL(puts, 1)
